...
/**
 * Created by Dylan on 2017-09-26.
 */

public class BasicVersusGameEngine {
    private static BasicVersusGameEngine instance;
    private BasicVersusGameGrid grid = null;
    ...
    private BasicVersusGameEngine() {
    }

    public static BasicVersusGameEngine getInstance() {
        if (instance == null)
            instance = new BasicVersusGameEngine();
        return instance;
    }
    ...
    public void createGrid(Context context, int difficulty) {
        ...
        grid = new BasicVersusGameGrid(context);
        grid.setGrid(Sudoku);
    }
    ...
    public BasicVersusGameGrid getGameGrid() {
        return grid;
    }
